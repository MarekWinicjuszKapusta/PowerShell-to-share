...
$LogFile = "$ENV:SystemDrive\support\logs\apps\TeamsAutoStart.log"
...
LogWrite "** STARTING Microsoft Teams Auto Start Off Helpdesk edition, if there are any issues, get in touch with Marek.Kapusta@fujitsu.com. **"
write-host "** STARTING Microsoft Teams Auto Start Off Helpdesk edition, if there are any issues, get in touch with Marek.Kapusta@fujitsu.com. **"
logwrite "Script started by: $env:UserName on $env:ComputerName"
...
LogWrite "** End of the Microsoft Teams Auto Start Off Helpdesk edition. **"
write-host "** End of the Microsoft Teams Auto Start Off Helpdesk edition. **"
